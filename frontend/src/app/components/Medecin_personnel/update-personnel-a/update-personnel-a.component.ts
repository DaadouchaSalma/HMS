...
@Component({
  selector: 'app-update-personnel-a',
  ...
  templateUrl: './update-personnel-a.component.html',
  styleUrl: './update-personnel-a.component.scss'
})
export class UpdatePersonnelAComponent implements OnInit{
  ...
  ngOnInit() {
    ...
    if (id) {
      this.personnelAService.getPersonnelAByIdAdmin(id).subscribe({
  ...
  onSubmit() {
    ...
    this.personnelAService.updatePersonnelAdmin(this.personnelA.id,updatedpharmacien).subscribe({
